...
//         if (GUILayout.Button(new GUIContent("Bookmark", EditorGUIUtility.IconContent("d_CacheServerDisconnected@2x").image), GUILayout.Height(30)))
//         {
//             RemoveNullScenes();
//         }
...
//     private void RemoveNullScenes()
//     {
//         List<EditorBuildSettingsScene> validScenes = new List<EditorBuildSettingsScene>();
